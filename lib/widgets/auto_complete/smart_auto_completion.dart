...
import 'package:assisto/widgets/auto_complete/future_widget.dart';
                ...
                data: (context, data) {
                  return ValueListenableBuilder(
                    ...
                    builder:
                      ...
                      if (hideNotifier.value) {
                        return const SizedBox.shrink();
                      }
                      return widget.suggestionsBuilder(context, data,_hideSuggestions);
                    },
                  );
                },
              );
